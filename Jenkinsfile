pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://34.235.112.15:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: ' https://github.com/Hemanth220524/FullstackAppForAWS.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://34.235.112.15:9090/springapp1"
            echo "✅ Frontend deployed: http://34.235.112.15:9090/frontapp1"
        }
        failure {
